    ...
    <header className="w-full h-20 bg-white shadow-2xl flex justify-between items-center px-[1%]">
      ...
      <nav>
        <ul className="flex mr-5 items-center">
          <li className="px-5 py-1 rounded-md  text-blue-500 font-bold text-xl hover:scale-110 hover:duration-500">
            <a href="/home">Home</a>
          </li>
          <li className="px-5 py-1 rounded-md  text-blue-500 font-bold text-xl hover:scale-110 hover:duration-500">
          ...
          {!isLoggedIn && (
            <li className="px-5 py-1 rounded-md  text-blue-500 font-bold text-xl hover:scale-110 hover:duration-500 hover:text-green-400">
              <Link to="/auth">Login</Link>
            </li>
          )}
              {isLoggedIn && (
                <button onClick={logoutHandler}>
                  <li className="px-5 py-1 rounded-md  text-blue-500 font-bold text-xl hover:scale-110 hover:duration-500 hover:text-red-400 ">
                    <a>Logout</a>
                  </li>
                </button>
              )}
          {isLoggedIn && (
            <li className="px-2 py-2 mx-2 rounded-3xl  text-blue-500 font-bold text-xl hover:scale-110 hover:duration-500 hover:bg-gray-200">
